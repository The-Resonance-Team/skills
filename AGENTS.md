...
- **Never edit installed skills** in client discovery dirs — installed skills are owned by their upstream repos and client loaders; `skills/` holds team-authored skills only.
